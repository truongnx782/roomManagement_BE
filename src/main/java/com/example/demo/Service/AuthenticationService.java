...
import com.example.demo.Repo.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        var taiKhoan = userRepository.findByUsername(request.getTenDangNhap()).orElseThrow(() -> new AppException(ErrorCode.ACCOUNT_NOT_EXISTED));

        PasswordEncoder passwordEncoder = new BCryptPasswordEncoder(10);


        boolean authenticated = passwordEncoder.matches(request.getMatKhau(), taiKhoan.getPassword());
